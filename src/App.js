...
const handleDrop = (e, chosenCategory) =>
{
  ...
  techniques.forEach(technique => {
    ...
    return (
        ...
        <Techniques handleDeleteTechnique={handleDeleteTechnique} handleTouchDragStart={handleTouchDragStart} handleTouchDragEnd={handleTouchDragEnd} handleDeleteNote={handleDeleteNote}  editNote={editNote} editVideo={editVideo} addNote={addNote} techniques={ techniques } />
        </div>
        <div class="center">
